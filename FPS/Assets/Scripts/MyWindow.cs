...
namespace FPS
{
    public class MyWindow : EditorWindow
    {
        ...
        //void MebiusStripBuild(GameObject root)
        //{
        //    for (int i = 0; i < _countObject; i++)
        //    {
        //        _angle = Mathf.Log(i) * Mathf.Sin(i / 2)/_countObject;
        //        Vector3 pos = new Vector3(Mathf.Cos(_angle), 0, Mathf.Sin(_angle)) * _radius;
        //        GameObject temp = Instantiate(ObjectInstantiate, pos, Quaternion.identity) as GameObject;
        ...
        //    }
        //}
        //void BoxBuild(GameObject root)
        //{
            
        //    for (int i = 0; i < _countObject; i++)
        //    {
        //        if (i == _countObject/4 || i == _countObject / 3 || i == _countObject / 2)
        //        {
        //            _angle += 90f;
        //        }
        //        Vector3 pos = new Vector3(Mathf.Sin(_angle),0,0);
        //        GameObject temp = Instantiate(ObjectInstantiate, pos, Quaternion.identity) as GameObject;
